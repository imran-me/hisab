 ...
 * Hisab · Insights
 *
 * There is no reports feature yet. This exists because the shell is mounted by
 ...
 *
 * It is replaced outright when the reports module is written. Nothing in this
 * file is a foundation to build on.
 */

import { mountShell } from '../../shared/js/components/shell.js';

mountShell({ title: 'Insights' });
